            ...
            switch (msg.what){
                ...
                case 300:
                    ...
                    if (time > 0){
                        ...
                        Intent intent = new Intent(GameActivity.this,SettleActivity.class);
                        intent.putExtra("list",(Serializable) poetryList);
                        intent.putExtra("key",tv_title.getText().toString());
...
//                        array = word.split("，");
                        ...
                        String address1 = wang_zhi+"/poetry/getone/"+word;
    ...
    private void insert() {
        ...
        String address = wang_zhi+"/record/insert/"+dates+"/"+userName+"/"+phone+"/飞花令/"+right;
    ...
    private void systemHttp(){
        String address2 = wang_zhi+"/poetry/getradom/"+tv_title.getText().toString();
...
//        answers = contentArray[0];
    ...
    private void createText(){
        ...
        tv_first = new TextView(this);
        tv_first.setTextSize(20);
        tv_first.setId(2);
        tv_second = new TextView(this);
...
//        tv_from.setText(info2);
        if(data.equals("")){
            tv_from.setText("未找到");
            tv_from.setTextColor(R.color.colorRedBg);
            ...
            tv_from.setTextColor(R.color.colorCorrect);
            tv_from.setTextSize(18);
            tv_from.setId(4);
            wrong ++;
            MediaPlayer mediaPlayer = MediaPlayer.create(getApplicationContext(),R.raw.wrong);
            ...
            tv_from.setId(4);
            right ++;
            Poetry poetry = new Poetry(title,word,author,dynasty);
...
//        tv_from.setId(4);
    ...
    private void createView(){
        ...
        ImageView img_xia = new ImageView(this);
        ...
        imgParams.topMargin = (int) TypedValue.applyDimension(
                TypedValue.COMPLEX_UNIT_DIP, 10, r.getDisplayMetrics());
        imgParams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        imgParams.addRule(RelativeLayout.BELOW,4);
        img_xia.setImageResource(R.drawable.xia);
        ...
        relativeLayout.addView(img_xia,imgParams);
