...
public class CountActivity extends AppCompatActivity {
    ...
    private LinearLayout changeUser;//切换账号
...
//                    Toast.makeText(getApplicationContext(),"头像",Toast.LENGTH_SHORT).show();
                ...
                case R.id.secondchange:
                    Intent intent1=new Intent(CountActivity.this, UpdatePassword.class);
...
//                    intent2.putExtra("index","fs");
                ...
                case R.id.fourthchange:
                    Intent intent4 = new Intent(CountActivity.this,UpdateName.class);
                    startActivity(intent4);
                    finish();
//                    Toast.makeText(getApplicationContext(),"更改昵称",Toast.LENGTH_SHORT).show();
                    break;
                case R.id.fifthchange:
                    Intent intent5 = new Intent(CountActivity.this,UpdateIntroduction.class);
...
//                    Toast.makeText(getApplicationContext(),"更改简介",Toast.LENGTH_SHORT).show();
                ...
                case  R.id.changeUser:
                    ...
                    editor2.clear();
                    editor2.apply();
                    Intent intent3 = new Intent(CountActivity.this,LoginActivity.class);
...
//                Toast.makeText(getApplicationContext(),"没有权限",Toast.LENGTH_SHORT).show();
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    Toast.makeText(getApplicationContext(),"我们需要此项权限以便上传图片",Toast.LENGTH_SHORT).show();
                }
//                else {
//                    // 申请授权。
//                    ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
//                }
            ...
            Toast.makeText(getApplicationContext(),"23之前",Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(Intent.ACTION_PICK,android.provider.MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
            intent.setType("image/*");
            startActivityForResult(intent,1);
        }
