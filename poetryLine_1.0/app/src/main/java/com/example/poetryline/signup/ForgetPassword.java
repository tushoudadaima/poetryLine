...
//                        }
    ...
    private void SaveUserData() {
        ...
        editor.putString("password",MD5.getMD5(et_password.getText().toString().trim().getBytes()));
        editor.apply();
    }
    ...
    private void registListener() {
        ...
        btn_forget_password.setOnClickListener(listener);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_getCode:
                    getCode();
                    break;
                case R.id.btn_forget_password://更新密码
//                    if(radio==1){
