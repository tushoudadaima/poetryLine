...
public class aaApapter extends BaseAdapter {
    private List<pinn> dingdans = new ArrayList<>();//数据源
    private int itemLayoutId;
    private Context context;

    //构造方法
    public aaApapter(Context context, List<pinn> dingdans, int itemLayoutId){
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        img.setImageURI(dingdans.get(position).getImgg());
