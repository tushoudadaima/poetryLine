package com.example.poetryline.LauarCalendar;
...
public class Lauar {
    ...
    // 农历部分假日
    private static String[] lunarHoliday = new String[] { "0101 春节", "0115 元宵", "0505 端午", "0707 七夕", "0715 中元", "0815 中秋", "0909 重阳", "1208 腊八", "1224 小年", "0100 除夕" };
