...
public class PoetryController {
	...
	@RequestMapping(value = "/getSome/{start}")
	@ResponseBody
	public List<Poetry> findAllBySome(@PathVariable(value="start")String start){
		List<Poetry> lists = this.poetryService.findBySome(start);
		return lists;
	}
