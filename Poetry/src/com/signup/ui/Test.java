...
//查询所有用户数据
	...
	//更改密码
	public static String updatePassword(String phone,String password) {
		SqlSession session = MybatisUtil.getSession();
		UserMapper userMapper = session.getMapper(UserMapper.class);
	...
	public static String updateName(String phone, String name) {
		SqlSession session = MybatisUtil.getSession();
		UserMapper userMapper = session.getMapper(UserMapper.class);
	...
	//修改简介
	public static String updateIntroduction(String phone, String introduction) {
		SqlSession session = MybatisUtil.getSession();
		UserMapper userMapper = session.getMapper(UserMapper.class);
	...
	public static String findIntroduction(String phone) {
		SqlSession session = MybatisUtil.getSession();
		UserMapper userMapper=session.getMapper(UserMapper.class);
		User name = userMapper.findIntroduction(phone);
